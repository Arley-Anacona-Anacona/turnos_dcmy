...
<?php
    ...
    class Empleado extends Conexion{
        ...
        function agregarEmpleado(int $cedula, string $nombres, string $apellidos, string $correo, string $clave, string $rol): bool {

          // Preparar la consulta
          $consulta = $this->db->prepare('INSERT INTO empleado (cedula, nombres, apellidos, correo, clave, rol) VALUES (:cedula, :nombres, :apellidos, :correo, :clave, :rol)');
